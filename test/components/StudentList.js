...
describe('components', () => {
  ...
  describe('StudentList', () => {
    it('should render correctly', () => {
      ...
      expect(output.props.className).toBe('pane')

      let [ _Header, _ListTable ] = output.props.children

      expect(_Header.type).toBe(Header)
      expect(_ListTable.type).toBe(ListTable)
    })
  })
  ...
  describe('Header', () => {
    it('should render properly', () => {
      ...
      expect(output.props.className).toBe('sub-header')
